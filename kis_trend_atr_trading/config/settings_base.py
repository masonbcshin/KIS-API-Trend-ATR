...
ENABLE_PIPELINE_HEALTH_MONITORING: bool = os.getenv(
    "ENABLE_PIPELINE_HEALTH_MONITORING",
    "false",
).lower() in (
    "true",
    "1",
...
PIPELINE_WORKER_HEARTBEAT_SEC: int = int(os.getenv("PIPELINE_WORKER_HEARTBEAT_SEC", "5"))
PIPELINE_WORKER_STALL_SEC: int = int(os.getenv("PIPELINE_WORKER_STALL_SEC", "20"))
ENABLE_PIPELINE_DEGRADED_MODE: bool = os.getenv(
    "ENABLE_PIPELINE_DEGRADED_MODE",
    "false",
).lower() in (
    "true",
    "1",
...
ENTRY_INTENT_QUEUE_DROP_POLICY: str = (
    str(os.getenv("ENTRY_INTENT_QUEUE_DROP_POLICY", "reject_new") or "reject_new").strip().lower()
    or "reject_new"
)
MAX_PENDING_INTENTS_PER_SYMBOL: int = int(os.getenv("MAX_PENDING_INTENTS_PER_SYMBOL", "1"))
MAX_DIRTY_SYMBOL_BATCH: int = int(os.getenv("MAX_DIRTY_SYMBOL_BATCH", "50"))
MAX_INTENT_QUEUE_DEPTH: int = int(os.getenv("MAX_INTENT_QUEUE_DEPTH", "1024"))
CANDIDATE_CLEANUP_INTERVAL_SEC: int = int(os.getenv("CANDIDATE_CLEANUP_INTERVAL_SEC", "30"))
